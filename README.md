...
Открыт к предложениям о работе в Узбекистане / удалённо. Готов к собеседованиям и тестовым заданиям     

Прошел полный курс **"Профессия Инженер по тестированию"** в Skillbox, где освоил ручное и автоматизированное тестирование.    
Ищу позицию Junior QA Engineer, чтобы применять свои навыки и развиваться дальше.

О себе:
- дата рождения: 08.07.1980 г.р.
- семейное положение: женат
- место проживания: г. Ташкент

### 🛠 Мой стек
- **Ручное тестирование:** Тест-дизайн, чек-листы, тест-кейсы, баг-репорты, YouGile
...
- **Документация:** Google Docs, Google Sheets
...
_Ожидаемая зароботная плата от 4,000,000 сум с последующим ростом_
